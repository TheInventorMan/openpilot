...
def state_control(frame, rcv_frame, plan, path_plan, CS, CP, state, events, v_cruise_kph, v_cruise_kph_last,
  ...
  lat_active = active and not (CS.left_blinker_on or CS.right_blinker_on)
  actuators.steer, actuators.steerAngle, lac_log = LaC.update(lat_active, CS.vEgo, CS.steeringAngle, CS.steeringRate, CS.steeringTorqueEps, CS.steeringPressed, CS.steeringRateLimited, CP, path_plan)
